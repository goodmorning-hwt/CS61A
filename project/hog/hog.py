...
def is_sus(num):
    return num_factors(num) == 4 or num_factors(num) == 3
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    is_sus_origin = is_sus(score)
    while is_sus_origin and not is_prime(score):
        score += 1
    return score
    # END PROBLEM 4
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    return sus_points(
        simple_update(num_rolls, player_score, opponent_score, dice)
    )
    # END PROBLEM 4
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    sus_score_delta = sus_update(0, score, opponent_score) - score
    if sus_score_delta >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
